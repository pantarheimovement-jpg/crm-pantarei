...
// כולל "רשומה ליום היכרות" — הסטטוס שבו נרשמות משתתפות בקורסי יום היכרות.
// עד 28.8 הוא נעדר מכאן, ולכן דף המורה הציג רק חלק מהרשומות בימי היכרות.
const REGISTERED_STATUSES = ['נרשם', 'רשום', 'רשומה ליום היכרות'];
