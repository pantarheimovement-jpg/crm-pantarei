...
export default function StudentCoursesEditor({ student, onUpdated }) {
  ...
  const COURSE_STATUSES = ['ליד חדש', 'במעקב ראשוני', 'רשומה ליום היכרות', 'היה ביום היכרות', 'לחזור לקראת הרשמה', 'רשום', 'ביטול הרשמה', 'לא רלוונטי'];

  // סדר עדיפות סטטוסים לחישוב סטטוס כללי
  const STATUS_PRIORITY = ['רשום', 'נרשם', 'רשומה ליום היכרות', 'ליד חדש', 'חדש', 'לחזור לקראת הרשמה', 'במעקב ראשוני', 'היה ביום היכרות', 'הודעה מוואטסאפ לבדיקה', 'לא רלוונטי'];
