...
const TUTORIAL_STEPS = [
  ...
  // ניוזלטר — שליחה
  {
    ...
    content: 'בוחרים ערוץ (מייל/ווצאפ/שניהם), תבנית, קבוצה ושולחים.\n\nבוואטסאפ יש שני מצבים: טקסט חופשי (מגיע רק למי שכתב לנו ב-24 שעות האחרונות) ותבנית מאושרת (מגיעה לכולן — לדיוור יזום). במצב תבנית בוחרים תבנית וממלאים שם קורס, מועד וקישור. אפשר גם להחריג נמענים מהקבוצה בלי להסיר אותם ממנה.',
