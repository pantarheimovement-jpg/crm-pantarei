...
const TUTORIAL_STEPS = [
  ...
  // הגדרות — תבניות
  {
    ...
    title: 'הגדרות — בניית תבניות הניוזלטר',
    content: 'כאן בונים את הניוזלטר עצמו:\n\n• בלוקי טקסט, תמונה, סרטון וכפתור\n• שכפול בלוקים בלחיצה\n• "שכפל תבנית" — עותק מלא של ניוזלטר קודם לעריכה, בלי להתחיל מאפס ובלי לדרוס את המקור\n• Preheader — טקסט תצוגה מקדימה (חשוב!)\n• alt text לתמונות — קריטי למניעת ספאם',
    tip: 'רוצה לשלוח ניוזלטר דומה לקודם? בחרי אותו ולחצי "שכפל תבנית" — השמירה תיצור תבנית חדשה, והמקור יישאר.',
    icon: Shield,
    iconColor: 'text-[#D29486]',
    bgColor: 'from-[#FDF8F0] to-[#f3e8e4]',
    navigateTo: '/CRMSettings',
    navigateLabel: 'עברי להגדרות CRM',
    practiceNote: 'נסי לבחור תבנית קיימת, ללחוץ "שכפל תבנית", לשנות את השם ולשמור.',
  },
