    ...
    <div className="min-h-screen bg-[var(--crm-bg)] p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          {[
            { label: 'נגבה בפועל', sublabel: '(סה"כ מצטבר)', value: fmt(totalCollected), icon: DollarSign, color: 'var(--crm-accent)', onClick: () => setOpenModal('collected') },
        ...
        {/* Table */}
        <div className="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100" style={{ borderRadius: 'var(--crm-border-radius)' }}>
