          ...
          <div className="p-6">
            {activeTab === 'subscribers' && (
              <div className="space-y-6">
                ...
                {loading ? (
                  ...
                  <div className="overflow-x-auto bg-white rounded-xl shadow-sm" style={{ borderRadius: 'var(--crm-border-radius)' }}>
                    <table className="w-full divide-y divide-gray-200">
                      <thead className="bg-[var(--crm-bg)]">
                        <tr>
                          ...
                          <tr key={sub.id} className="hover:bg-gray-50">
                            ...
                            <td className="px-4 py-4 text-sm">
                              <select
                                ...
                                className="w-full px-2 py-1 text-xs rounded-lg border-2 focus:ring-2"
                                style={{
                                  backgroundColor: 'var(--crm-primary)',
                                  color: 'white',
                            ...
                            <td className="px-4 py-4 text-sm">
                              {sub.subscribed ? (
                                <span className="px-3 py-1 text-xs font-medium text-white whitespace-nowrap" style={{ borderRadius: 'var(--crm-button-radius)', backgroundColor: 'var(--crm-action)' }}>
                                  {t('פעיל', 'Active')}
                                </span>
                              ) : (
                                <span className="px-3 py-1 text-xs font-medium bg-gray-100 text-gray-800 whitespace-nowrap" style={{ borderRadius: 'var(--crm-button-radius)' }}>
                                  {t('לא פעיל', 'Inactive')}
                                </span>
                              )}
                            </td>
                            <td className="px-4 py-4 text-sm">
                              <div className="flex items-center gap-2">
                                <button
                                  ...
                                  onMouseEnter={(e) => e.currentTarget.style.backgroundColor = 'var(--crm-primary)' + '20'}
            ...
            {activeTab === 'send' && (
              <div className="space-y-6 max-w-4xl">
                <div className="bg-white border-2 border-[var(--crm-accent)] rounded-xl p-6" style={{ borderRadius: 'var(--crm-border-radius)' }}>
                  <h3 className="font-semibold text-xl text-[var(--crm-text)] mb-4" style={{ fontFamily: 'var(--font-headings)' }}>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <button
                      ...
                      className={`p-4 border-2 transition-all ${
                        sendChannel === 'email'
                          ? 'bg-[var(--crm-primary)]/10'
                          : 'border-gray-300 hover:border-[var(--crm-accent)]'
                      }`}
                      style={{
                        borderRadius: 'var(--crm-border-radius)',
                    ...
                    >
                      <Mail className="w-8 h-8 mx-auto mb-2" style={{ color: 'var(--crm-primary)' }} />
                    ...
                    <button
                      ...
                      className={`p-4 border-2 transition-all ${
                        sendChannel === 'whatsapp'
                          ? 'bg-[var(--crm-action)]/20'
                          : 'border-gray-300 hover:border-[var(--crm-accent)]'
                      }`}
                      style={{
                        borderRadius: 'var(--crm-border-radius)',
                        borderColor: sendChannel === 'whatsapp' ? 'var(--crm-action)' : undefined
                      }}
                    >
                      <MessageCircle className="w-8 h-8 mx-auto mb-2" style={{ color: 'var(--crm-action)' }} />
                    ...
                    <button
                      ...
                      className={`p-4 border-2 transition-all ${
                        sendChannel === 'both'
                          ? 'bg-[var(--crm-accent)]/30'
                          : 'border-gray-300 hover:border-[var(--crm-accent)]'
                      }`}
                      style={{
                        borderRadius: 'var(--crm-border-radius)',
                        borderColor: sendChannel === 'both' ? 'var(--crm-accent)' : undefined
                      }}
                    >
                      <div className="flex items-center justify-center gap-2 mb-2">
                        <Mail className="w-6 h-6" style={{ color: 'var(--crm-primary)' }} />
                        <MessageCircle className="w-6 h-6" style={{ color: 'var(--crm-action)' }} />
                      </div>
                ...
                {(sendChannel === 'whatsapp' || sendChannel === 'both') && (
                  <div className="bg-white border-2 border-[var(--crm-action)] rounded-xl p-6" style={{ borderRadius: 'var(--crm-border-radius)' }}>
                    <h3 className="font-semibold text-xl text-[var(--crm-text)] mb-4 flex items-center gap-2" style={{ fontFamily: 'var(--font-headings)' }}>
                      <MessageCircle className="w-6 h-6" style={{ color: 'var(--crm-action)' }} />
